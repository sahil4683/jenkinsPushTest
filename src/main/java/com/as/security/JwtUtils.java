...
public class JwtUtils {
	...
	@Value("${aligate.app.jwtSecret}")
	private String jwtSecret;

	@Value("${aligate.app.jwtExpirationMs}")
	...
	public String generateJwtToken(Authentication authentication) {
		...
		.signWith(SignatureAlgorithm.HS512, jwtSecret) //Set Hash Algo Type & Unique Key 
		.compact(); //Actually builds the JWT and serializes it to a compact
